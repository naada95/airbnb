...
const MONGO_URI = process.env.MONGO_URI || "mongodb://airbnb_app:apppassword123@localhost:27017/airbnb";
...
const listings = [
  {
    ...
    location: { street: "12 Derb Sidi Ahmed", city: "Marrakech", country: "Morocco", country_code: "MA",
      coordinates: { type: "Point", coordinates: [-7.9811, 31.6295] } },
    amenities: ["WiFi", "Air conditioning", "Kitchen", "Pool", "Washer"],
    photos: ["https://images.unsplash.com/photo-1570213489059-0aac6626cade?w=800","https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800","https://images.unsplash.com/photo-1531088009183-5ff5b7c95f91?w=800"],
  ...
  },
  {
    ...
    location: { street: "Camino del Mar 45", city: "Marbella", country: "Spain", country_code: "ES",
      coordinates: { type: "Point", coordinates: [-4.8861, 36.5097] } },
    amenities: ["WiFi", "Pool", "Air conditioning", "Kitchen", "Parking", "Gym", "BBQ"],
    photos: ["https://images.unsplash.com/photo-1613977257363-707ba9348227?w=800","https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800","https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800"],
  ...
  },
  {
    ...
    location: { street: "15 Rue de la Paix", city: "Paris", country: "France", country_code: "FR",
      coordinates: { type: "Point", coordinates: [2.3308, 48.8698] } },
    amenities: ["WiFi", "Kitchen", "Washer", "Elevator", "Heating"],
    photos: ["https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800","https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800","https://images.unsplash.com/photo-1484154218962-a197022b5858?w=800"],
  ...
  },
  {
    ...
    location: { street: "Jl. Pantai Seminyak", city: "Bali", country: "Indonesia", country_code: "ID",
      coordinates: { type: "Point", coordinates: [115.1449, -8.6906] } },
    amenities: ["WiFi", "Pool", "Air conditioning", "Kitchen", "Breakfast"],
    photos: ["https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?w=800","https://images.unsplash.com/photo-1544550285-f813152fb2fd?w=800","https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800"],
  ...
  },
  {
    ...
    location: { street: "Loch Ness Road", city: "Inverness", country: "United Kingdom", country_code: "GB",
      coordinates: { type: "Point", coordinates: [-4.2247, 57.4778] } },
    amenities: ["WiFi", "Fireplace", "Kitchen", "Parking", "Hot tub", "Pets allowed"],
    photos: ["https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800","https://images.unsplash.com/photo-1595521624167-83d90e934c9d?w=800","https://images.unsplash.com/photo-1599946347371-68eb71b16afc?w=800"],
  ...
  },
  {
    ...
    location: { street: "123 Lakeview Drive", city: "Muskoka", country: "Canada", country_code: "CA",
      coordinates: { type: "Point", coordinates: [-79.3832, 45.0000] } },
    amenities: ["WiFi", "Fireplace", "Kitchen", "BBQ", "Kayak", "Fishing gear", "Pets allowed"],
    photos: ["https://images.unsplash.com/photo-1449158743715-0a90ebb6d2d8?w=800","https://images.unsplash.com/photo-1475855581690-80accde3ae2b?w=800","https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800"],
  ...
  },
  {
    ...
    location: { street: "Forest Trail Rd", city: "Portland", country: "United States", country_code: "US",
      coordinates: { type: "Point", coordinates: [-122.6765, 45.5231] } },
    amenities: ["WiFi", "Kitchen", "Fireplace", "Hiking trails"],
    photos: ["https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=800","https://images.unsplash.com/photo-1544465544-1b71aee9dfa3?w=800","https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800"],
  ...
  },
  {
    ...
    location: { street: "Private Island", city: "Maldives", country: "Maldives", country_code: "MV",
      coordinates: { type: "Point", coordinates: [73.5093, 1.9770] } },
    amenities: ["WiFi", "Pool", "Air conditioning", "Kitchen", "Boat", "Snorkeling gear", "Chef"],
    photos: ["https://images.unsplash.com/photo-1573843981267-be1999ff37cd?w=800","https://images.unsplash.com/photo-1439130490301-25e322d88054?w=800","https://images.unsplash.com/photo-1548574505-5e239809ee19?w=800"],
  ...
  },
  {
    ...
    location: { street: "Prinsengracht 421", city: "Amsterdam", country: "Netherlands", country_code: "NL",
      coordinates: { type: "Point", coordinates: [4.8897, 52.3676] } },
    amenities: ["WiFi", "Kitchen", "Washer", "Bikes", "Heating"],
    photos: ["https://images.unsplash.com/photo-1534430480872-3498386e7856?w=800","https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800","https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800"],
  ...
  },
  {
    ...
    location: { street: "Emirates Hills Boulevard", city: "Dubai", country: "United Arab Emirates", country_code: "AE",
      coordinates: { type: "Point", coordinates: [55.1562, 25.0657] } },
    amenities: ["WiFi", "Pool", "Gym", "Spa", "Restaurant", "Butler", "Parking"],
    photos: ["https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800","https://images.unsplash.com/photo-1582719508461-905c673771fd?w=800","https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800"],
  ...
  },
  {
    ...
    location: { street: "Rua do Surf 7", city: "Lisbon", country: "Portugal", country_code: "PT",
      coordinates: { type: "Point", coordinates: [-9.1393, 38.7223] } },
    amenities: ["WiFi", "Kitchen", "Surfboard storage", "Outdoor shower", "Bikes"],
    photos: ["https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=800","https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6?w=800","https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800"],
  ...
  },
  {
    ...
    location: { street: "145 Bedford Ave", city: "New York", country: "United States", country_code: "US",
      coordinates: { type: "Point", coordinates: [-73.9566, 40.7170] } },
    amenities: ["WiFi", "Kitchen", "Washer", "Dryer", "Gym access", "Rooftop"],
    photos: ["https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800","https://images.unsplash.com/photo-1502672023488-70e25813eb80?w=800","https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800"],
...
async function seed() {
  try {
    ...
    console.log("Deconnecte. Rechargez localhost:4200 !");
  } catch (err) {
    if (err.insertedDocs) {
      console.log(err.insertedDocs.length + " inseres, certains ont echoue.");
    }
